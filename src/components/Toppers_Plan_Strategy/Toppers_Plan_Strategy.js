...
import "./Toppers_Plan_Strategy.css";

const ToppersPlanStrategy = () => {
    return (
        <>
            <div className='strategy_card'>
                <div className='plan_strategy_heading'> <h2>Toppers Strategy and planning</h2></div>
                <div className='multiple_toppers_advices'>
                    <div className='toppers_advice'>
                        ...
                        <h3 className='name'>J.K. Thakur (SSC CGL AIR-1, 2021)</h3>
                    </div>
                    ...
                    <div className='toppers_advice'>
                        ...
                        <h3 className='name'>Rahul Kumar ( SSC, CPO  AIR - 01, 2022 )</h3>
                    </div>
                    ...
                    <div className='toppers_advice'>
                        ...
                        <h3 className='name'>A.K.Singh  ( SSC CHSL AIR - 11, 2022 )</h3>
                    </div>
                    ...
                    <div className='toppers_advice'>
                        ...
                        <h3 className='name'>Anish Kumar ( SSC AIR - 15, 2020 )</h3>
                    </div>
                </div>
            </div>
        </>
